...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AttendanceLockedException.class)
    public ResponseEntity<ApiResponse<Void>> handleAttendanceLocked(AttendanceLockedException ex) {
        log.warn("GlobalExceptionHandler:handleAttendanceLocked :: {}", ex.getMessage());
        return ResponseEntity.status(HttpStatus.LOCKED).body(ApiResponse.error(ex.getMessage()));
    }
